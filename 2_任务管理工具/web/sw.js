const CACHE='rixu-v6-hd-icon';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','../assets/logo.svg','../assets/rixu-hd.ico','../assets/icon-32.png','../assets/icon-48.png','../assets/icon-192.png','../assets/icon-512.png'];
